...
check_wsl_environment() {
    ...
    if [[ -n "${WSL_DISTRO_NAME:-}" ]]; then
        ...
        if [[ -d "$HOME/.vscode-server" ]]; then
            ...
            print_warning "⚠️  VS Code Server not found. Install it by opening this folder from VS Code on Windows."
        fi
    else
        print_warning "⚠️  Not running in WSL. This script is optimized for WSL/Linux environments."
    fi
}
...
check_python_environment() {
    ...
    if command_exists python3; then
        ...
        if command_exists pip3; then
            ...
            print_warning "⚠️  pip3 not found"
        fi
    else
        print_warning "⚠️  Python3 not found. Install Python for AI development."
    fi
}
...
check_node_environment() {
    ...
    if command_exists node; then
        ...
        print_warning "⚠️  Node.js not found. Install Node.js for JavaScript development."
    fi
}
